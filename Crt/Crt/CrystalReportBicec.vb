...
Public Class CrystalReportBicec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crt.CrystalReportBicec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportBicec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportBicec = New CrystalReportBicec()
        rpt.Site = Me.Site
        Return rpt
    End Function
