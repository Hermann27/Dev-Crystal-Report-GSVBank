...
Public Class CrystalReportBicec1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrystalReportBicec1.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crt.CrystalReportBicec1.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedCrystalReportBicec1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportBicec1 = New CrystalReportBicec1()
        rpt.Site = Me.Site
        Return rpt
    End Function
